...
async def initiate_bot():
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("synxsupport")
            await ASS_CLI_1.join_chat("synxupdate")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("szteambots")
            await ASS_CLI_4.join_chat("slbotzone")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("szteambots")
            await ASS_CLI_5.join_chat("slbotzone")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("szteambots")
            await LOG_CLIENT.join_chat("slbotzone")
        except:
            pass
